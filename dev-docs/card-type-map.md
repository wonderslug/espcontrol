...
| `light_control` | Lights | `src/webserver/types/light_temperature.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `light` | Yes | Visible Tabs | Hidden | Contract, Codec, Parser, HA, Backup |
