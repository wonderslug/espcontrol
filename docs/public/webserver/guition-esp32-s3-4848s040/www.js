...
(function () {
  ...
  var CSS =
    ...
    ".sp-slider-preview{position:absolute;right:0;top:0;bottom:0;width:30%;" +
    ...
    ".sp-slider-knob{position:absolute;left:12%;right:12%;bottom:60%;height:4px;border-radius:1px;" +
