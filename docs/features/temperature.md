...
The top bar of your panel can show one or more temperature sensors from Home Assistant. You'll find the temperature list in the **Clock Bar** section of the **Settings** tab on the [Setup](/features/setup) page.

- **Temperature** — add a row for each temperature sensor you want in the clock bar.
...
When more than one temperature is configured, the top bar shows the values side by side, separated by slashes.
