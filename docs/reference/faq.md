...
- **10.1-inch JC8012P4A1 V2/new panel** — 20 cards (4 rows, 5 columns), for boards marked `V2` on the rear label
...
- **JC8012P4A1 V2/new panel** — 10.1-inch, 1280x800 landscape orientation (ESP32-P4), for boards marked `V2` on the rear label
