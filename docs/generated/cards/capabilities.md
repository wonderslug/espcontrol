...
| Sensor | sensor | sensor, binary_sensor, text_sensor | Yes | Own picker item | Large Sensor Numbers; Input Unit: default, seconds, minutes, hours, days; Active Color; Status Translation; Input Status; Display Text; Input Status 2; Display Text 2 | Visible |
