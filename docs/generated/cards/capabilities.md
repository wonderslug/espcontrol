...
| Media | media | media_player | Yes | Own picker item | Type: play_pause, previous, next, volume, position, now_playing, playlist; Type: default, state; Controls: default, progress, play_pause; Maximum Volume: 1-100; Media Content ID / URI; Large Media Numbers | Visible |
