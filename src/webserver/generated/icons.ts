...
export const GENERATED_ICON_NAMES: readonly string[] = [
    ...
    "Key", "Lamp", "Lamp Outline", "LAN", "Laptop", "Lawnmower",
    ...
    "Monitor", "Motion Sensor", "Motion Sensor Off", "Movie Roll", "Music", "Music Box Multiple",
    "Music Note", "Music Note Quarter", "Nintendo Switch", "Outdoor Lamp", "Oven", "Palette",
    ...
    "Speaker", "Speaker Pause", "Speaker Play", "Spotlight", "Spotlight Beam", "Sprinkler",
    ...
    "Vacuum Outline", "Video Off", "View Headline", "Volume High", "Volume Off", "Wall Outlet",
