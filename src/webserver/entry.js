...
(function () {
  ...
  var ICON_NAMES = [
    ...
    "Swap Horizontal", "Swap Vertical", "Power Socket UK", "Power Socket EU", "Power Socket US", "Sun",
    ...
    "Trash Can Outline", "View Headline", "Volume High", "Wall Outlet", "Wall Sconce", "Washing Machine",
